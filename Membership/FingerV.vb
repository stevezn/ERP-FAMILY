...
Public Class FingerV
    Dim myDB As SQLiteConnection
    Dim WithEvents FpVer As FlexCodeSDK.FinFPVer
    Dim EmpID As String
    Dim FpIndex As Byte

    Private Sub FingerV_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        startv()
    End Sub
    ...
    Private Sub FpVer_FPVerificationStatus(ByVal Status As FlexCodeSDK.VerificationStatus) Handles FpVer.FPVerificationStatus
        ...
        ElseIf Status = FlexCodeSDK.VerificationStatus.v_VerificationFailed Then
            TextBox1.Text = TextBox1.Text & vbNewLine & "Verification failed"
        ElseIf Status = FlexCodeSDK.VerificationStatus.v_ActivationIncorrect Then
            TextBox1.Text = TextBox1.Text & vbNewLine & "Incorrect activation number of devices"
        ElseIf Status = FlexCodeSDK.VerificationStatus.v_NoDevice Then
            TextBox1.Text = TextBox1.Text & vbNewLine & "No device connected"
        ElseIf TextBox1.Text = FlexCodeSDK.VerificationStatus.v_FPListFull Then
            TextBox1.Text = TextBox1.Text & vbNewLine & "FPListFull"
        Else
